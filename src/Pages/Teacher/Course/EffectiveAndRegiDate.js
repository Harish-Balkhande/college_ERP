    ...
    <Box p={3}>
      ...
      <Paper elevation={3} sx={{ p: 3, mb: 4 }}>
        ...
        <Grid container spacing={3}>
          ...
          <Grid item xs={12} sm={6} md={6} lg={4}>
            <FormControl fullWidth required sx={{ minWidth: '190px' }}>
              <InputLabel sx={labelStyles}>Class Section *</InputLabel>
              <Select
                value={filters.branch}
                onChange={handleChange('classSession')}
                label="Class Section *"
              >
                <MenuItem value="">Choose</MenuItem>
                <MenuItem value="mca">MCA</MenuItem>
                <MenuItem value="mca-I">MCA-I</MenuItem>
                <MenuItem value="mca-II">MCA-II</MenuItem>
                <MenuItem value="mca-III">MCA-III</MenuItem>
              </Select>
            </FormControl>
          </Grid>
...
export default EffectiveAndRegiDate;
